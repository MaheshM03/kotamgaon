										...
										<div class="col-md-12">
											...
											<div class="col-lg-12 p-t-20">
												...
												<div class="mdl-textfield mdl-js-textfield txt-full-width">
													<input type="text" name="title" value="<?php echo $meter_data->title; ?>" class="mdl-textfield__input" > 
											...
											<div class="col-lg-12 p-t-20">
												...
												<div class="mdl-textfield mdl-js-textfield txt-full-width">
													<input type="text" name="sub_title" value="<?php echo $meter_data->sub_title; ?>" class="mdl-textfield__input" > 
											...
											<div class="col-lg-12 p-t-20">
												...
												<div class="col-md-12">
													...
													<?php if($meter_data->image!=""){ ?>
															...
															<img src="<?php echo base_url(); ?>assets/images/animal/<?php echo $meter_data->image; ?>" alt="Girl in a jacket" width="100" height="100">
