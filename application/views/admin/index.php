		...
		<div class="container-login100 ">
			...
			<form class="login100-form validate-form"  method ="post">
					...
					<div class="wrap-input100 validate-input" data-validate="Enter username">
						<input class="input100" type="text" name="admin_username" placeholder="Username" value="<?php if(isset($_COOKIE["adminUsername"])) { echo $_COOKIE["adminUsername"]; } ?>" required>
						<span class="focus-input100" ></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate="Enter password">
						<input class="input100" type="password" name="admin_password" placeholder="Password" value="<?php if(isset($_COOKIE["adminPassword"])) { echo $_COOKIE["adminPassword"]; } ?>" required>
						<span class="focus-input100" > </span>
					</div>
					<!--<div class="contact100-form-checkbox">
						<input class="input-checkbox100" id="ckb1" type="checkbox" name="remember-me" <?php if(isset($_COOKIE["adminUsername"])) { ?> checked <?php } ?>>
						<label class="label-checkbox100" for="ckb1">
							Remember me
						</label>
					</div>-->
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" type="submit" name="login-btn" value="admin-login">
							Login
						</button>
					</div>
					<!-- <?php echo base_url(); ?>signin/forgot_password -->
					<div class="text-center p-t-30">
						<a class="txt1" href="<?php echo base_url(); ?>Admin/forgot_password">
							Forgot Password?
						</a>
					</div> 
				</form>
