	...
	<div class="container">
		<div class="row align-items-center">
			<div class="col-lg-6 col-xl-7 text-right text-lg-start mb-4 mb-lg-0">
				<h3 class="text-color-light text-transform-none text-5 line-height-2 line-height-lg-1 mb-1"> <?php echo $education->news_title; ?> </h3> </div>
		</div>
	</div>
</section>
        ...
        <div class="row align-items-center justify-content-center mb-5">
            ...
            <div class="col-lg-12 pb-sm-4 pb-lg-0 mb-5 mb-lg-0">
                ...
                <div class="news-content">
                    <?php echo $education->news_description; ?>
                </div>
